...
window.onload = function init() {
  ...
  document.getElementById("txSlider").onchange = function(event) { tx = parseFloat(event.target.value); render();};
  document.getElementById("tySlider").onchange = function(event) { ty = parseFloat(event.target.value); render();};
  document.getElementById("tzSlider").onchange = function(event) { tz = parseFloat(event.target.value); render();};
  document.getElementById("rxSlider").onchange = function(event) { rx = parseFloat(event.target.value); render();};
  document.getElementById("rySlider").onchange = function(event) { ry = parseFloat(event.target.value); render();};
  document.getElementById("rzSlider").onchange = function(event) { rz = parseFloat(event.target.value); render();};
  document.getElementById("sxSlider").onchange = function(event) { sx = parseFloat(event.target.value); render();};
  document.getElementById("sySlider").onchange = function(event) { sy = parseFloat(event.target.value); render();};
  document.getElementById("szSlider").onchange = function(event) { sz = parseFloat(event.target.value); render();};
